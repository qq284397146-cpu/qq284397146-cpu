...
| 方向 | 具体技能 | 项目证明 |
|------|---------|---------|
| **影像标注** | 肝脏/肺部血管手工精细分割、ROI勾画 | [肝脏血管3D重建](https://github.com/qq284397146-cpu/liver-vessel-segmentation) |
| **数据工程** | DICOM批量处理、元数据提取、格式转换 | [医学影像数据处理工具](https://github.com/qq284397146-cpu/Medical-Image-Data-Tools) |
| **三维可视化** | CT/MRI体渲染、多视角截图、视频生成 | [影像标注作品集](https://github.com/qq284397146-cpu/Medical-Image-Annotation-Portfolio) |
